...
def get_model(point_cloud, is_training, num_class, bn_decay=None):
    ...
    l01_points = pointnet_fp_module(l0_xyz, l1_xyz, l0_points, l1_points, [512], is_training, bn_decay,scope='fa_layer1')
    ...
    l02_points = pointnet_fp_module(l0_xyz, l2_xyz, l0_points, l2_points, [512], is_training, bn_decay,scope='fa_layer2')
    ...
    l03_points = pointnet_fp_module(l0_xyz, l3_xyz, l0_points, l3_points, [512], is_training, bn_decay,scope='fa_layer3')
    ...
    l04_points = pointnet_fp_module(l0_xyz, l4_xyz, l0_points, l4_points, [512], is_training, bn_decay,scope='fa_layer4')
    ...
    # FC layers
    l0_points=tf.concat([l01_points,l02_points,l03_points,l04_points],axis=-1)#2048
    l0_points = tf_util.dropout(l0_points, keep_prob=0.8, is_training=is_training, scope='dp1')

    net = tf_util.conv1d(l0_points, 512, 1, padding='VALID', bn=True, is_training=is_training, scope='fc1',bn_decay=bn_decay)
    net = tf_util.dropout(net, keep_prob=0.8, is_training=is_training, scope='dp2')

    net = tf_util.conv1d(net, 128, 1, padding='VALID', bn=True, is_training=is_training, scope='fc2', bn_decay=bn_decay)
    end_points['feats'] = net

    net = tf_util.dropout(net, keep_prob=0.8, is_training=is_training, scope='dp3')
    net = tf_util.conv1d(net, num_class, 1, padding='VALID', activation_fn=None, scope='fc3')##(B,L,num_class)
...
if __name__=='__main__':
    with tf.Graph().as_default():
        ...
        _,_ = get_model(inputs, tf.constant(True), 10)
        #print(net)
